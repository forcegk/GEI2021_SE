...
\begin{tikzpicture}[->,>=stealth, shorten >=1pt, auto, node distance=3.2cm, semithick]
    ...
    % Puntos y rayas
    \node[state]                (punto)    [below right of=vacio]           {$\frac{\punto}{\overset{\punto}{\text{\textcolor{green}{\punto} + 1s}}}$};
    \node[state]                (raya)     [above right of=vacio]           {$\frac{\raya}{\overset{\raya}{\text{\textcolor{green}{\punto} + 3s}}}$};
